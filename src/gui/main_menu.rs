...
pub fn main_menu(gs : &mut State, ctx : &mut Rltk) -> MainMenuResult {
    ...
    draw_batch.print_color_centered(20, "Caverns Descent", ColorPair::new(RGB::named(rltk::YELLOW), RGB::named(rltk::BLACK)));
    draw_batch.print_color_centered(21, "by Nathan Rude", ColorPair::new(RGB::named(rltk::CYAN), RGB::named(rltk::BLACK)));
